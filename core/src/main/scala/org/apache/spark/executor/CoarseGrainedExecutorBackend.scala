...
private[spark] class CoarseGrainedExecutorBackend(
  ...
  override def receiveWithLogging = {
    ...
    case LaunchTask(data) =>
      if (executor == null) {
        ...
        executor.launchTask(this, taskDesc.taskId, taskDesc.name, taskDesc.serializedTask, cores)
      }
  ...
  override def statusUpdate(taskId: Long, state: TaskState, data: ByteBuffer, actualCores: Int){
    driver ! StatusUpdate(executorId, taskId, state, data, actualCores)
  }
}
